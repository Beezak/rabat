...
public class Home extends NavigationBar{
    ...
    private final By StartMonthDropDownInputField =By.name("param[start_month]");
    ...
    private final By LoanTypDropDown =By.name("param[milserve]");
    ...
    public Home selectMonth(String value){
        ...
        ActOn.element(driver, StartMonthDropDownInputField).selectValue(value);
        return this;
    }
    ...
    public Home selectLoanType(String value){
        ...
        ActOn.element(driver, LoanTypDropDown).selectValue(value);
        return this;
    }
